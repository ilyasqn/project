"""RabbitMQ event publisher for AI Service."""
...
async def publish_ai_event(event_type: str, data: dict[str, Any]) -> None:
    """
    Publish AI-related events.

    Args:
        event_type: Type of event (generation.completed, analysis.completed)
        data: Data to include in the event
    """
    publisher = await get_publisher()
    routing_key = f"ai.{event_type}"
