"""RabbitMQ implementation of UserEventPublisher."""
...
from ...domain.ports.event_publisher import UserEventPublisher

logger = logging.getLogger(__name__)


class RabbitMQUserEventPublisher(UserEventPublisher):
